...
guideSections:
  ...
  - title: Setup guides
    description: These pieces help you choose a fixture and place it sensibly inside a shelf, rack, or countertop setup.
    slugs:
      - grow-lights/best-grow-lights-for-herbs
      - hydroponics/countertop-hydroponic-herbs-beginner
  - title: Troubleshooting
    description: Use these when herbs stretch, pale out, or underperform under artificial light.
    slugs:
      - plant-problems/why-basil-leaves-yellow-indoors
      - hydroponics/hydroponic-lettuce-growing-slowly
  - title: Advanced topics
    description: Once the basics are stable, these guides help fine-tune crop density and equipment fit.
    slugs:
      - hydroponics/hydroponic-nutrients-ec-ph-basics
      - grow-lights/best-grow-lights-for-herbs
---

Grow lights are one of the most misunderstood parts of small-space gardening because they are often sold through product language instead of plant language. Shoppers see wattage, spectrum, and marketing claims, but what actually matters is simpler: how much usable light reaches the crop over the day, and whether the fixture fits the real footprint.
