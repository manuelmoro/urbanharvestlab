...
imageAlt: Educational overview showing how herb light needs differ between sunny windows, lower-light homes, and grow light setups
keyTakeaways:
...
comparisonTable:
  ...
  columns:
    - Situation
    - Light level
    - Herbs most likely to work
    - Main caution
  rows:
    - ["Sunny balcony or strong south-facing window", "High", "Basil, thyme, oregano, rosemary, parsley, chives", "Heat and fast drying can become the limiting factor"]
    - ["Bright window with some direct sun", "Moderate to high", "Basil, parsley, chives, mint, thyme", "Basil may still struggle if the direct sun period is short"]
    - ["Bright room with little direct sun", "Moderate", "Parsley, chives, mint", "Expect slower growth and lower productivity from high-light herbs"]
...
![Diagram showing stronger and weaker window light zones for herbs](/images/how-much-light-herbs-need/window-light-zones-for-herbs.webp)
...
This is why a guide like [How Many Hours Should Grow Lights Run for Herbs?](/blog/grow-lights/how-many-hours-grow-lights-herbs/) works best as a follow-up, not as a replacement for understanding light need itself. Herbs care about the total usable light they receive, not just the timer number.
...
![Educational diagram showing grow light distance, coverage, and canopy placement for herbs](/images/how-much-light-herbs-need/grow-light-distance-and-coverage.webp)
...
![Visual checklist of common low-light symptoms in potted herbs](/images/how-much-light-herbs-need/signs-herbs-need-more-light.webp)
