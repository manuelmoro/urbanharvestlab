...
- How to instantly diagnose visual symptoms of poor pruning on your plants.
- A quick decision framework to know exactly when to cut to force massive, bushy regrowth.

If your plants are actively dying, do not prune them; read [Potted Herb Care: Watering, Feeding, and Pruning](/blog/urban-gardening/potted-herb-care/) to fix the root cause first. Otherwise, keep reading to stop harvesting incorrectly and start multiplying your yields.
...
If you are mixing these plants in a single container as discussed in [Best Herbs for Small Spaces](/blog/urban-gardening/best-herbs-small-spaces/), you must address each individual plant with the right techique.
...
- **Pruning a stressed plant:** If your plant is wilting from [poor watering routines](/blog/urban-gardening/how-often-to-water-potted-herbs/), chopping half its leaves off will finish it. Fix the environment first.
