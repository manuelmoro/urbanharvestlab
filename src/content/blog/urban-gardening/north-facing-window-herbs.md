---
title: "North-Facing Window Herbs: What Actually Works and When You Need a Grow Light"
description: "Have a north-facing apartment? Don't give up on indoor gardening. Learn which herbs tolerate shade, how to maximize weak indirect light, and when it's time to buy an LED."
excerpt: "A north-facing window is widely considered the death sentence of an indoor garden. But with the right selection of shade-tolerant herbs and strategic placement, you can still harvest fresh greens year-round."
slug: "urban-gardening/north-facing-window-herbs"
...
published: true
draft: false
cluster_role: "scenario guide"
affiliate: false
featured: false
popular: false
publishDate: 2026-03-25
image: /images/urban-gardening/north-facing-window-herbs.webp
imageAlt: Clean UI illustration showing shade-tolerant mint and chives growing under supplemental LED light in a dim north-facing window
keyTakeaways:
  - North-facing windows provide the weakest, coolest light of any exposure. They never receive intense, direct rays of the sun.
  - Mediterranean, sun-loving herbs like Rosemary, Thyme, and Basil will not survive in a north-facing window without artificial help.
  - Broad-leaf, shade-tolerant herbs like Mint, Chives, Parsley, and Lemon Balm can adapt to northern exposures if placed immediately against the glass.
  - If your north window is shadowed by a neighboring building, or if winter days grow short, a small supplemental LED grow light is mandatory to prevent leggy growth.
beginnerPathTitle: Explore your window options
beginnerPathSlugs:
...
topicLinksTitle: Adding supplemental light to a dark room
topicLinksDescription: If your north window isn't cutting it, these guides will help you integrate an LED light without ruining your apartment's aesthetic.
topicLinkSlugs:
  - grow-lights/led-vs-fluorescent-grow-lights
  - grow-lights/grow-light-distance-herbs
  - grow-lights/how-many-hours-grow-lights-herbs
faq:
  - question: Can I just put my basil right up against the cold glass of a north window?
    answer: No. Even an inch away from the glass, the light intensity of a north window is not enough for basil, which requires 6-8 hours of direct, blazing sun. Furthermore, the cold transfer from winter glass will likely shock and stunt the tropical plant.
  - question: How can I tell if my north-facing window is too dark even for mint?
    answer: Watch how the plant grows. If the mint produces a long, pale stem with inches of bare space between the leaves (called "etiolation" or growing "leggy"), it is desperately reaching for a light source that doesn't exist. You need a grow light immediately.
  - question: Should I rotate my pots in a north-facing window?
    answer: Yes, always. Because the light is coming weakly from one single direction, the plants will aggressively lean toward the glass. Rotate them 90 degrees every time you water to ensure balanced, upright growth.
comparisonTable:
  caption: "The North-Facing Window Survival List"
  columns:
    - Herb
    - North-Window Viability
...
When attempting to grow plants indoors without direct sunlight, as outlined heavily in [Can Herbs Grow Indoors Without Direct Sunlight?](/blog/grow-lights/can-herbs-grow-indoors-without-direct-sunlight/), you must understand the Inverse Square Law of Light. 
...
Instead, look to the broad-leafed, moisture-loving herbs that naturally grow low to the ground in the shade of larger plants in the wild. For a full breakdown of these plant structures, revisit [Best Herbs for Small Spaces: What Grows Well in Apartments, Balconies, and Windowsills](/blog/urban-gardening/best-herbs-small-spaces/).

Here are the four champions of the Northern Window:

1. **Mint:** Mint is famously invasive precisely because it is so resilient. It has incredibly broad leaves capable of capturing weak ambient light. Because north windows are generally cooler, mint actually appreciates the break from intense heat.
2. **Chives:** While chives prefer full sun, they are highly adaptable. Your harvest will not be as thick or vibrant as outdoor chives, but they will reliably push up fresh green spears for your baked potatoes. 
3. **Parsley:** Another broad-leaf herb that naturally grows close to the damp forest floor. It thrives in cool temperatures and will tolerate the dim, diffused light of a northern exposure nicely. 
4. **Lemon Balm:** A close relative to mint, lemon balm shares its shade tolerance and will produce heavily scented, citrusy leaves even on a cloudy day. 
