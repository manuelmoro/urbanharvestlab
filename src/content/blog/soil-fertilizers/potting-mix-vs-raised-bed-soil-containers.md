...
keyTakeaways:
  - Potting mix is engineered for container airflow and drainage.
  - Raised bed soil is usually too dense for long-term container performance.
  - Structure matters before fertility when choosing a container medium.
topicLinksTitle: If you're working on container growing fundamentals, also read
topicLinksDescription: These pieces connect potting mix choices with crop fit, root volume, and the most common container stress signals.
topicLinkSlugs:
...
faq:
  - question: Can raised bed soil be used in containers?
    answer: It is usually too heavy and compacting for containers unless it is heavily modified, and even then a proper potting mix is normally the better starting point.
  - question: Why does container structure matter so much?
    answer: Because roots in containers depend on a narrow balance of air and moisture. Dense mixes collapse that balance quickly.
relatedSlugs:
  - containers-planters/container-depth-tomatoes-peppers-herbs
  - urban-gardening/balcony-herb-garden-beginners
---

Are your container plants suddenly turning yellow, dropping leaves, or suffocating despite your careful watering schedule? While it is tempting to blame the fertilizer or the weather, the hidden killer in most failed container gardens is the soil itself: specifically, using dense raised bed soil or garden dirt instead of a specialized potting mix.
...
If you are just starting your urban garden, review our guide on [Balcony Herb Garden for Beginners](/blog/urban-gardening/balcony-herb-garden-beginners/) to see how container size affects your soil choice. Otherwise, keep reading to understand why proper potting mix is non-negotiable for container success.
...
- **Lower leaves turning pale yellow:** If the oldest leaves on your plant are uniformly yellow and dropping off, and the soil feels heavy and wet, you are experiencing **root suffocation**. If this sounds familiar, read [Why Are My Basil Leaves Turning Yellow Indoors?](/blog/plant-problems/why-basil-leaves-yellow-indoors/) for a deep dive. Dense raised bed soil traps water, drowning the roots.
...
If you are confused about how deep your soil needs to be, cross-reference your crop with our [Container Depth for Tomatoes, Peppers, and Herbs](/blog/containers-planters/container-depth-tomatoes-peppers-herbs/) guide to ensure proper volume.
