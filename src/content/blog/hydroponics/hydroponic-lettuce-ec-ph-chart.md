...
image: /images/hydroponics/hydroponic-lettuce-ec-ph-chart.webp
imageAlt: Clean UI illustration showing a hydroponic lettuce setup alongside an elegant EC and pH optimal range chart
keyTakeaways:
  - Hydroponic lettuce requires a relatively low nutrient concentration (EC 0.8 to 1.2) compared to fruiting crops like tomatoes.
  - Keep the pH strictly between 5.5 and 6.0. If the pH drifts higher, the lettuce will suffer nutrient lockout and turn yellow.
  - High EC levels are the primary cause of "tip burn" (brown, crispy edges) on indoor hydroponic lettuce.
beginnerPathTitle: Build your hydroponic knowledge in this order
beginnerPathSlugs:
  - hydroponics/countertop-hydroponic-herbs-beginner
  - hydroponics/hydroponic-nutrients-ec-ph-basics
topicLinksTitle: Troubleshooting your hydroponic greens? Read these
topicLinksDescription: If your lettuce looks pale, is growing too slowly, or has crispy edges, these guides will help you diagnose the water chemistry.
topicLinkSlugs:
  - hydroponics/hydroponic-nutrients-ec-ph-basics
  - hydroponics/hydroponic-lettuce-growing-slowly
  - hydroponics/root-rot-hydroponics-prevention
faq:
  - question: What should the EC be for hydroponic lettuce?
    answer: The optimal Electrical Conductivity (EC) for hydroponic lettuce is between 0.8 and 1.2 mS/cm. Seedlings should start lower (around 0.5), and mature plants can handle up to 1.2.
  - question: Why are the edges of my hydroponic lettuce turning brown?
    answer: This is called "tip burn," and it is almost always caused by an EC that is too high, inadequate airflow, or a lack of calcium reaching the leaf edges.
  - question: How often should I test the pH in a countertop hydroponic system?
    answer: You should check the pH at least twice a week. Plants naturally alter the pH of the water as they consume different nutrients.
comparisonTable:
  caption: "The Hydroponic Lettuce Chemistry Chart"
  columns:
    - Stage of Growth
    - Optimal pH Range
    - Target EC (mS/cm)
